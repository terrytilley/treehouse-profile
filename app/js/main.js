// $.getJSON('https://teamtreehouse.com/terrytilley.json', function(data) {
//   console.log(data);
// });
// $.ajax({
//   url: 'https://teamtreehouse.com/terrytilley.json',
//   dataType: 'json',
//   type: 'get',
//   cache: false,
//   success: function(data) {
//     $(data.badges).each(function(index, value) {
//         // console.log(value.name);
//         $("header").html("<h1>Welcome to the profile of " + value.name + "!</h1>");
//     });
//   }
// });

/* In the getJSON function, change the username from "username" to whatever your Treehouse username is. */
$.getJSON("https://teamtreehouse.com/terrytilley.json",function(treehouse){
...
/* ------------------------------------------------ */
    ...
    // $('.banner').prepend($('<img class="img-responsive img-circle center-block" width="150" height="150" src="'+gravatar_url+'"/>'));
